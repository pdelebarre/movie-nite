...
})(GlobalNamespace$1 || (GlobalNamespace$1 = {}));
...
function gFactory({ ebconfig, options }) {
    ...
    return { ...GlobalNamespace$1, ...defaultG };
}
...
function authFactory(globals) {
    ...
    const signIn = async (userID, password) => {
        ...
        try {
            ...
            if (resData.token) {
                ...
                g.mounted = true;
                const [validTokenRes, { hash }, { fromUtf8 }] = await Promise.all([tokenPost(POST_TYPES$1.VALID_TOKEN), Promise.resolve().then(function () { return require('./sha256-29deba40.js'); }).then(function (n) { return n.sha256; }), Promise.resolve().then(function () { return require('./index-283d697f.js'); })]);
    ...
    const resetUserPassword = async (currentPassword, newPassword) => {
        ...
        try {
            const setAttrsRes = await tokenPost(POST_TYPES$1.RESET_PASSWORD, { currentPassword, newPassword });
...
function tableFactory(globals) {
    ...
    async function fullTableSize(tableName) {
        const res = await tokenPost(POST_TYPES$1.TABLE_SIZE, tableName ? { tableName } : {});
        if (res.success) {
    ...
    async function tableTypes(tableName) {
        const res = await tokenPost(POST_TYPES$1.COLUMN_TYPES, tableName ? { tableName } : {});
        if (res.success) {
...
var EasybaseProvider = function EasybaseProvider(_ref) {
          ...
          var _temp7 = function () {
            if (g.ebconfig.tt && g.ebconfig.integration.split("-")[0].toUpperCase() !== "PROJECT") {
              ...
              return Promise.resolve(initAuth()).then(function () {
                return Promise.resolve(tokenPost(POST_TYPES$2.VALID_TOKEN)).then(function (res) {
              ...
              return Promise.resolve(cache.getCacheTokens(cookieName)).then(function (_ref2) {
                ...
                var _temp5 = function () {
                  if (cacheRefreshToken) {
                    ...
                    return Promise.resolve(Promise.all([tokenPost(POST_TYPES$2.REQUEST_TOKEN, {
                      refreshToken: g.refreshToken,
                      token: g.token,
                      getUserID: true
                    }), Promise.resolve().then(function () { return require('./sha256-29deba40.js'); }).then(function (n) { return n.sha256; }), Promise.resolve().then(function () { return require('./index-283d697f.js'); })])).then(function (_ref3) {
            ...
            var _temp12 = function () {
              if (options.googleAnalyticsId.startsWith("G-")) {
                var _temp13 = function () {
                  if (g.instance === "React") {
                    return Promise.resolve(Promise.resolve().then(function () { return require('./ga-4-react.esm-29baef84.js'); })).then(function (_ref4) {
  ...
  var currentConfiguration = function currentConfiguration() {
    return _extends$1({}, _frameConfiguration);
  };
  ...
  var addRecord = function addRecord(options) {
    try {
      ...
      var fullOptions = _extends$1({}, defaultValues, options);

      return Promise.resolve(_catch(function () {
        return Promise.resolve(tokenPost(POST_TYPES$2.SYNC_INSERT, fullOptions)).then(function (res) {
          return {
            message: res.data,
            success: res.success
          };
  ...
  var deleteRecord = function deleteRecord(options) {
    try {
      ...
      if (_frameRecord && _recordIdMap.get(_frameRecord)) {
        return Promise.resolve(tokenPost(POST_TYPES$2.SYNC_DELETE, {
    ...
    try {
      var _temp17 = function _temp17() {
        return _catch(function () {
          return Promise.resolve(tokenPost(POST_TYPES$2.GET_FRAME, _frameConfiguration)).then(function (res) {
      ...
      var _realignFrames = function _realignFrames(newData) {
        ...
        if (newData.length !== _frame.length) {
          ...
          for (var i = 0; i < newData.length; i++) {
            var newDataNoId = _extends$1({}, newData[i]);
        ...
        if (_isFrameInitialized) {
          var _temp19 = function () {
            if (_observedChangeStack.length > 0) {
              ...
              return Promise.resolve(tokenPost(POST_TYPES$2.SYNC_STACK, _extends$1({
...
var Auth = React.lazy(function () {
  return Promise.resolve().then(function () { return require('./Auth-d3611110.js'); }).then(function (n) { return n.Auth; });
});
...
//# sourceMappingURL=index-59eecc83.js.map
