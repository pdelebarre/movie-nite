import React__default, { createContext, Fragment, useState, useRef, useEffect, useContext, Suspense, lazy } from 'react';
    ...
    const signIn = async (userID, password) => {
        ...
        try {
            ...
            if (resData.token) {
                ...
                g.mounted = true;
                const [validTokenRes, { hash }, { fromUtf8 }] = await Promise.all([tokenPost(POST_TYPES$1.VALID_TOKEN), import('./sha256-cbcfc640.js').then(function (n) { return n.s; }), import('./index-66c37f86.js')]);
      ...
      if (g.ebconfig.tt && g.ebconfig.integration.split("-")[0].toUpperCase() !== "PROJECT") {
        ...
        if (cacheRefreshToken) {
          ...
          const [refreshTokenRes, {
            ...
            token: g.token,
            getUserID: true
          }), import('./sha256-cbcfc640.js').then(function (n) { return n.s; }), import('./index-66c37f86.js')]);
...
const Auth = lazy(() => import('./Auth-016a6bca.js').then(function (n) { return n.A; }));
...
export { EasybaseProvider as E, _extends$1 as _, commonjsGlobal as a, callFunction as b, createCommonjsModule as c, getDefaultExportFromCjs as g, index as i, useEasybase as u };
//# sourceMappingURL=index-9b07a9d3.js.map
