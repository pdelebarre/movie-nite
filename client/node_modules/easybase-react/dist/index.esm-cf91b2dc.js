...
function useController({ name, rules, defaultValue, control, shouldUnregister, }) {
    ...
    const [value, setInputStateValue] = React__namespace.useState(isUndefined(get(fieldsRef.current, name)._f.value) || isFieldArray
...
//# sourceMappingURL=index.esm-cf91b2dc.js.map
