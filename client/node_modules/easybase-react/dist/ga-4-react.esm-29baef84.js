...
var outputGA4 = (children, setComponents, ga4) => {
  setComponents(React__default['default'].Children.map(children, (child, index) => {
...
var GA4R = (_ref) => {
  ...
  return React__default['default'].createElement(React__default['default'].Fragment, null, components);
};
...
function withTracker(MyComponent) {
  return props => {
    ...
    return React__default['default'].createElement(MyComponent, Object.assign({}, props));
  };
}
...
//# sourceMappingURL=ga-4-react.esm-29baef84.js.map
