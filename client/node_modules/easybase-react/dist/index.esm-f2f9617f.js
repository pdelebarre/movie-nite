var index = require('./index-59eecc83.js');
var React = require('react');
var Auth = require('./Auth-d3611110.js');
...
var Form = Auth.qe.form(function (props) {
  ...
  }, props.theme.form ? index._extends({}, props.theme.form) : {});
});
function Form$1 (props) {
  return React__default['default'].createElement(Form, Object.assign({}, props), props.children);
}

var Label = Auth.qe.label(function (props) {
  return index._extends({
    display: "none",
    fontFamily: "inherit"
  }, props.theme.textFieldLabel ? index._extends({}, props.theme.textFieldLabel) : {});
});
function Label$1 (props) {
  return React__default['default'].createElement(Label, Object.assign({}, props));
}

var TextFieldRoot = Auth.qe.div(function (props) {
  return index._extends({
    position: 'relative',
    width: '100%',
    maxWidth: '100%',
    ...
    height: 46,
    fontFamily: "inherit"
  }, props.theme.textFieldRoot ? index._extends({}, props.theme.textFieldRoot) : {});
});
var TextField = Auth.qe.input(function (props) {
  return index._extends({
    display: "block",
    width: '100%',
    background: '0 0',
    border: 'none',
    fontFamily: "inherit"
  }, props.theme.textField ? index._extends({}, props.theme.textField) : {});
});
var Bar = Auth.qe.div(function (props) {
  return props.theme.textFieldBar ? index._extends({}, props.theme.textFieldBar) : {};
});
function Input (props) {
  return React__default['default'].createElement(TextFieldRoot, null, React__default['default'].createElement(TextField, Object.assign({
    placeholder: "\xA0"
  }, props, props.register(), {
    id: "textField-" + props.label.replace(/[^a-zA-Z]+/g, '')
  })), React__default['default'].createElement(Bar, null), React__default['default'].createElement(Label$1, {
    htmlFor: "textField-" + props.label.replace(/[^a-zA-Z]+/g, '')
  }, props.label));
}

function EmailInput (props) {
  return React__default['default'].createElement(Input, Object.assign({
    label: "Email",
    autoComplete: "email"
  }, props, {
    type: "email",
...
var HeaderText = Auth.qe.h1(function (props) {
  return index._extends({
    fontFamily: "inherit",
    fontSize: 24,
    fontWeight: 500,
  ...
  }, props.theme.headerText ? index._extends({}, props.theme.headerText) : {});
});
function HeaderText$1 (props) {
  return React__default['default'].createElement(HeaderText, Object.assign({}, props));
}

var TextButton = Auth.qe.button(function (props) {
  return index._extends({
    cursor: "pointer",
    color: '#635bff',
    whiteSpace: 'nowrap',
    ...
    background: 'none',
    border: 'none'
  }, props.theme.textButton ? index._extends({}, props.theme.textButton) : {});
});
function TextButton$1 (props) {
  return React__default['default'].createElement(TextButton, Object.assign({}, props, {
    type: "button"
  }));
}

var SecondaryButton = Auth.qe(TextButton$1)(function (props) {
  return index._extends({
    margin: '15px'
  }, props.theme.secondaryButton ? index._extends({}, props.theme.secondaryButton) : {});
});
function SecondaryButton$1 (props) {
  return React__default['default'].createElement(SecondaryButton, Object.assign({}, props));
}

var SubmitButtonRoot = Auth.qe.div(function (props) {
  return props.theme.submitButtonRoot ? props.theme.submitButtonRoot : {};
});
var SubmitButton = Auth.qe.button(function (props) {
  return index._extends({
    position: 'relative',
    border: "none",
  ...
  }, props.theme.submitButton ? index._extends({}, props.theme.submitButton) : {});
});
function SubmitButton$1 (props) {
  return React__default['default'].createElement(SubmitButtonRoot, null, React__default['default'].createElement(SubmitButton, Object.assign({
    type: "submit"
  }, props)));
}
...
exports.Form = Form$1;
exports.HeaderText = HeaderText$1;
exports.Input = Input;
...
//# sourceMappingURL=index.esm-f2f9617f.js.map
